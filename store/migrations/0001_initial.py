# Generated by Django 3.1.5 on 2021-04-25 21:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_stars', models.IntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)])),
                ('author', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='store.customer')),
                ('product', models.ManyToManyField(related_name='product_review', to='store.Product')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
